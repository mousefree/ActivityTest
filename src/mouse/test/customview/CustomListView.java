...
//					headView2.setPadding(0, (int) (-1 * headView2Height + i), 0, 0);
					...
					if(i - j >= 0){
						if(i - j <= headView1Height) {
							...
							headView1.setPadding(0, headView1.getPaddingTop(), 0, 0);										
			...
			case MotionEvent.ACTION_UP:
				...
				new Thread() {
                    public void run() {
						...
						while(headView1.getPaddingTop() > -1 * headView1Height) {
...
/*
	...
	public void setIsShowNaviImgHeadView(boolean isShowNaviImgHeadView) {
		...
		if(isShowNaviImgHeadView) {
			this.addHeaderView(headView2, null, true);
